      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-8 lg:mb-16">
          ...
          <div className="relative flex justify-center w-full max-w-sm mx-auto lg:max-w-none">
            <img
              src="/Images/Invest & Collaboration.webp"
              alt="Demo"
        ...
        <div ref={videoRef} className="mt-16 mb-16 relative">
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            {/* Floating badges/icons around the video */}
            <div className="absolute -top-6 -left-6 w-16 h-16 bg-[#0378c0] rounded-full flex items-center justify-center shadow-lg transform -translate-y-1/4 -translate-x-1/4">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M9 18V5l12 7-12 7z" />
              </svg>
            </div>
            
            <div className="absolute -bottom-4 -right-4 w-14 h-14 bg-[#ff007a] rounded-full flex items-center justify-center shadow-lg">
              <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12 7-12 7z" />
              </svg>
            </div>
            
            <div className="absolute top-1/4 -right-6 w-12 h-12 bg-[#8a00ff] rounded-full flex items-center justify-center shadow-lg">
...
//               <div className="relative bg-[#111827] rounded-xl p-0.5 backdrop-blur-xl overflow-hidden shadow-inner">
//                 {/* Decorative corners */}
//                 <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-[#0378c0] rounded-tl-lg"></div>
//                 <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-[#8a00ff] rounded-tr-lg"></div>
//                 <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-[#ff007a] rounded-bl-lg"></div>
//                 <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-[#ff007a] rounded-br-lg"></div>
...
//                       playing={isPlaying}
//                       controls={true}
//                       light={<div className="absolute inset-0 flex items-center justify-center bg-black">
...
//                               e.target.src = "/Images/Invest & Collaboration.webp";
//                             }}
//                           />
//                           {/* Premium play button */}
//                           <div className="absolute inset-0 flex items-center justify-center">
...
//                               {/* Outer glow */}
//                               <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
//                               {/* Button */}
//                               <div className="relative bg-white bg-opacity-10 backdrop-blur-md rounded-full p-5 border border-white border-opacity-20 shadow-xl group-hover:scale-105 transition-transform duration-300">
//                                 <svg
...
//                               </div>
//                               {/* Ripple effect */}
//                               <div className="absolute -inset-4 rounded-full border border-white border-opacity-20 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-700"></div>
//                               <div className="absolute -inset-8 rounded-full border border-white border-opacity-10 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-1000 delay-100"></div>
//                             </div>
//                           </div>
//                           {/* Overlay text */}
//                           <div className="absolute bottom-6 left-0 right-0 text-center">
//                             <p className="text-white text-lg md:text-xl font-semibold bg-black bg-opacity-30 backdrop-blur-sm py-2 px-4 mx-auto inline-block rounded-full">
//                               Watch Demo
//                             </p>
//                           </div>
//                         </div>
